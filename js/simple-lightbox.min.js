                    ...
                    this.addEventListener(
                      ...
                      function (t) {
                        if (o.isValidLink(t.currentTarget)) {
                          ...
                          (o.initialImageIndex = o.elements.indexOf(
                            t.currentTarget
                          )),
                  ...
                  (e = [
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        for (var o in (e.dispatchEvent(
                          new Event('close.simplelightbox')
                        ),
                        ...
                        this.fadeOut(
                          ...
                          function () {
                            t.options.disableScroll &&
                              t.toggleScrollbar('show'),
                              t.options.htmlClass &&
                                '' !== t.options.htmlClass &&
                                document
                                  .querySelector('html')
                    ...
                    },
                    {
                      ...
                      value: function () {
                        ...
                        s.addEventListener('load', function (t) {
                          ...
                          -1 === o.loadedImages.indexOf(e) &&
                            o.loadedImages.push(e),
                            o.relatedElements[i].dispatchEvent(
                              new Event('nextImageLoaded.' + o.eventNamespace)
                            );
                        }),
                          s.setAttribute(
                            'src',
                            this.relatedElements[e].getAttribute(
                          ...
                          a.addEventListener('load', function (t) {
                            ...
                            -1 === o.loadedImages.indexOf(e) &&
                              o.loadedImages.push(e),
                              o.relatedElements[i].dispatchEvent(
                                new Event('prevImageLoaded.' + o.eventNamespace)
                              );
                          }),
                          a.setAttribute(
                            'src',
                            this.relatedElements[n].getAttribute(
                              this.options.sourceAttr
                            )
                          );
                      },
                        ...
                        t.setAttribute(
                          ...
                          t.addEventListener('error', function (t) {
                            r.relatedElements[
                              ...
                              new Event('error.' + r.eventNamespace)
                            ),
                              (r.isAnimating = !1),
                              (r.isOpen = !0),
                            ...
                            var e = 1 === a || -1 === a;
                            if (
                              r.initialImageIndex === r.currentImageIndex &&
                              e
                            )
                              return r.close();
                            r.options.alertError &&
                              alert(r.options.alertErrorMessage),
                              r.loadImage(e ? a : 1);
                          }),
                          t.addEventListener('load', function (t) {
                            void 0 !== a &&
                              (r.relatedElements[
                                ...
                                new Event('changed.' + r.eventNamespace)
                              ),
                              r.relatedElements[
                                r.currentImageIndex
                              ].dispatchEvent(
                                new Event(
                                  (1 === a ? 'nextDone' : 'prevDone') +
                                    '.' +
                                    r.eventNamespace
                                )
                              )),
                              ...
                              -1 ===
                                r.loadedImages.indexOf(
                                  r.currentImage.getAttribute('src')
                                ) &&
                                r.loadedImages.push(
                                  r.currentImage.getAttribute('src')
                                );
                            ...
                            (r.domNodes.image.style.top =
                              (window.innerHeight - n) / 2 + 'px'),
                              (r.domNodes.image.style.left =
                                (window.innerWidth -
                                  i -
                                  r.globalScrollbarWidth) /
                                  2 +
                                'px'),
                              ...
                              'string' == typeof r.options.captionSelector
                                ? (e =
                                    'self' === r.options.captionSelector
                                      ? r.relatedElements[r.currentImageIndex]
                                      : r.relatedElements[
                                          r.currentImageIndex
                                        ].querySelector(
                                          r.options.captionSelector
                                        ))
                                : 'function' ==
                                    typeof r.options.captionSelector &&
                                  (e = r.options.captionSelector(
                                    r.relatedElements[r.currentImageIndex]
                                  )),
                              r.options.captions &&
                                e &&
                                (o =
                                  'data' === r.options.captionType
                                    ? e.dataset[r.options.captionsData]
                                    : 'text' === r.options.captionType
                                    ? e.innerHTML
                                    : e.getAttribute(r.options.captionsData)),
                              r.options.loop ||
                                (0 === r.currentImageIndex &&
                                  r.hide(
                                    r.domNodes.navigation.querySelector(
                                      '.sl-prev'
                                    )
                                  ),
                                r.currentImageIndex >=
                                  r.relatedElements.length - 1 &&
                                  r.hide(
                                    r.domNodes.navigation.querySelector(
                                      '.sl-next'
                                    )
                              ...
                              1 === r.relatedElements.length
                                ? r.hide(
                                    r.domNodes.navigation.querySelectorAll(
                                      '.sl-prev, .sl-next'
                                    )
                                  )
                                : r.show(
                              ...
                              r.options.additionalHtml &&
                                ...
                                ((r.domNodes.additionalHtml =
                                  document.createElement('div')),
                                r.domNodes.additionalHtml.classList.add(
                                  'sl-additional-html'
                                ),
                                (r.domNodes.additionalHtml.innerHTML =
                                  r.options.additionalHtml),
                                r.domNodes.image.appendChild(
                                  r.domNodes.additionalHtml
                                ));
                          });
                      },
                      ...
                      value: function () {
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              ...
                              t.preventDefault(),
                                (o.controlCoordinates.swipeDiff = 0),
                                o.loadImage(
                                  t.currentTarget.classList.contains('sl-next')
                                    ? 1
                                    : -1
                                );
                            }
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              if (
                                ...
                                return !0;
                              0 == o.controlCoordinates.containerHeight &&
                                ((o.controlCoordinates.containerHeight =
                                  o.getDimensions(o.domNodes.image).height),
                                (o.controlCoordinates.containerWidth =
                                  o.getDimensions(o.domNodes.image).width),
                                (o.controlCoordinates.imgHeight =
                                  o.getDimensions(o.currentImage).height),
                                (o.controlCoordinates.imgWidth =
                                  o.getDimensions(o.currentImage).width),
                                (o.controlCoordinates.containerOffsetX =
                                  o.domNodes.image.offsetLeft),
                                (o.controlCoordinates.containerOffsetY =
                                  o.domNodes.image.offsetTop),
                                (o.controlCoordinates.initialOffsetX =
                                  parseFloat(
                                    o.currentImage.dataset.translateX
                                  )),
                                (o.controlCoordinates.initialOffsetY =
                                  parseFloat(
                                    o.currentImage.dataset.translateY
                                  ))),
                                t.preventDefault();
                              var e = t.delta || t.wheelDelta;
                              void 0 === e && (e = t.detail),
                                (e = Math.max(-1, Math.min(1, e))),
                                (i += e * o.options.scrollZoomFactor * i),
                                (i = Math.max(
                                  1,
                                  Math.min(o.options.maxZoom, i)
                                )),
                                (o.controlCoordinates.targetScale = i),
                                (o.controlCoordinates.pinchOffsetX = t.pageX),
                                (o.controlCoordinates.pinchOffsetY = t.pageY),
                                (o.controlCoordinates.limitOffsetX =
                                  (o.controlCoordinates.imgWidth *
                                    o.controlCoordinates.targetScale -
                                    o.controlCoordinates.containerWidth) /
                                  2),
                                ...
                                (o.controlCoordinates.scaleDifference =
                                  o.controlCoordinates.targetScale -
                                  o.controlCoordinates.initialScale),
                                ...
                                o.zoomPanElement(
                                  o.controlCoordinates.targetOffsetX + 'px',
                                  o.controlCoordinates.targetOffsetY + 'px',
                                  o.controlCoordinates.targetScale
                                ),
                                1 < o.controlCoordinates.targetScale
                                  ? ((o.controlCoordinates.zoomed = !0),
                                    o.domNodes.caption.style.opacity ||
                                      'none' ===
                                        o.domNodes.caption.style.display ||
                                      o.fadeOut(
                                        o.domNodes.caption,
                                        o.options.fadeSpeed
                                      ))
                                  : (1 === o.controlCoordinates.initialScale &&
                                    ...
                                    (o.controlCoordinates.initialPinchDistance =
                                      null),
                                    (o.controlCoordinates.capture = !1)),
                                (o.controlCoordinates.initialPinchDistance =
                                  o.controlCoordinates.targetPinchDistance),
                                (o.controlCoordinates.initialScale =
                                  o.controlCoordinates.targetScale),
                                (o.controlCoordinates.initialOffsetX =
                                  o.controlCoordinates.targetOffsetX),
                        ...
                        this.addEventListener(
                          ...
                          function (t) {
                            ...
                            if ('mousedown' === t.type)
                              t.preventDefault(),
                                (o.controlCoordinates.initialPointerOffsetX =
                                  t.clientX),
                                (o.controlCoordinates.initialPointerOffsetY =
                                  t.clientY),
                                (o.controlCoordinates.containerHeight =
                                  o.getDimensions(o.domNodes.image).height),
                                (o.controlCoordinates.containerWidth =
                              ...
                              if (
                                ((o.controlCoordinates.touchCount =
                                  t.touches.length),
                                (o.controlCoordinates.initialPointerOffsetX =
                                  t.touches[0].clientX),
                                (o.controlCoordinates.initialPointerOffsetY =
                                ...
                                if (o.controlCoordinates.doubleTapped)
                                  return (
                                    ...
                                    setTimeout(function () {
                                      o.currentImage &&
                                        o.currentImage.classList.remove(
                                          'sl-transition'
                                        );
                                    }, 200),
                                    !1
                                ...
                                2 === o.controlCoordinates.touchCount &&
                                  ((o.controlCoordinates.initialPointerOffsetX2 =
                                    t.touches[1].clientX),
                                  (o.controlCoordinates.initialPointerOffsetY2 =
                                    t.touches[1].clientY),
                                  (o.controlCoordinates.initialOffsetX =
                                    parseFloat(
                                      o.currentImage.dataset.translateX
                            ...
                            return (
                              !!o.controlCoordinates.mousedown ||
                              (o.transitionCapable &&
                                (o.controlCoordinates.imageLeft = parseInt(
                              ...
                              (o.controlCoordinates.swipeStart =
                                t.pageX || t.touches[0].pageX),
                              (o.controlCoordinates.swipeYStart =
                            ...
                            function (t) {
                              ...
                              if ('touchmove' === t.type) {
                                if (!1 === o.controlCoordinates.capture)
                                  return !1;
                                (o.controlCoordinates.pointerOffsetX =
                                  t.touches[0].clientX),
                                  ...
                                  1 < o.controlCoordinates.touchCount
                                    ? ((o.controlCoordinates.pointerOffsetX2 =
                                        t.touches[1].clientX),
                              ...
                              if (
                                ...
                                if (
                                  (t.preventDefault(),
                                  !1 === o.controlCoordinates.capture)
                                )
                                  return !1;
                                (o.controlCoordinates.pointerOffsetX =
                                  t.clientX),
                              ...
                              o.controlCoordinates.zoomed ||
                                ((o.controlCoordinates.swipeEnd =
                                  t.pageX || t.touches[0].pageX),
                                (o.controlCoordinates.swipeYEnd =
                                  t.pageY || t.touches[0].pageY),
                                (o.controlCoordinates.swipeDiff =
                                  o.controlCoordinates.swipeStart -
                                  o.controlCoordinates.swipeEnd),
                                (o.controlCoordinates.swipeYDiff =
                                  o.controlCoordinates.swipeYStart -
                                  o.controlCoordinates.swipeYEnd),
                                o.options.animationSlide &&
                                  o.slide(
                                    0,
                                    -o.controlCoordinates.swipeDiff + 'px'
                                  ));
                            }
                          ),
                          this.addEventListener(
                            ...
                            function (t) {
                              if (
                                ...
                                o.options.loop ||
                                  (0 === o.currentImageIndex &&
                                    o.controlCoordinates.swipeDiff < 0 &&
                                    (e = !1),
                                  o.currentImageIndex >=
                                    o.relatedElements.length - 1 &&
                                    0 < o.controlCoordinates.swipeDiff &&
                                    (e = !1)),
                                  Math.abs(o.controlCoordinates.swipeDiff) >
                                    o.options.swipeTolerance && e
                                    ? o.loadImage(
                                        0 < o.controlCoordinates.swipeDiff
                                          ? 1
                                          : -1
                                    ...
                                    : o.options.animationSlide &&
                                      o.slide(
                                        o.options.animationSpeed / 1e3,
                                        '0px'
                                      ),
                                  o.options.swipeClose &&
                                    50 <
                                      Math.abs(
                                        o.controlCoordinates.swipeYDiff
                                      ) &&
                                    Math.abs(o.controlCoordinates.swipeDiff) <
                                      o.options.swipeTolerance &&
                                    o.close();
                              }
                            }
                          ),
                                ...
                                return (
                                  ...
                                  setTimeout(function () {
                                    o.currentImage &&
                                      ...
                                      (o.currentImage.style[
                                        o.transitionPrefix + 'transform-origin'
                                      ] = null));
                                  }, 200),
                                  !(o.controlCoordinates.capture = !0)
                                );
                    ...
                    },
                    {
                      ...
                      value: function (t) {
                        ...
                        t.dispatchEvent(
                          ...
                          (this.isAnimating = !0),
                          (this.currentImageIndex =
                            this.relatedElements.indexOf(t));
                        ...
                        (this.currentImage = document.createElement('img')),
                          ...
                          (this.domNodes.counter.querySelector(
                            '.sl-total'
                          ).innerHTML = this.relatedElements.length),
                          this.adjustImage(),
                          this.options.preloading && this.preload(),
                          setTimeout(function () {
                            t.dispatchEvent(
                              new Event('shown.' + e.eventNamespace)
                            );
                      ...
                      value: function () {
                        ...
                        this.removeEventListener(
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              document === t.target ||
                                e.domNodes.wrapper === t.target ||
                                e.domNodes.wrapper.contains(t.target) ||
                                e.domNodes.wrapper.focus();
                            }
                          );
                      },
                    },
                      ...
                      value: function (t, e) {
                        ...
                        try {
                          for (i.s(); !(o = i.n()).done; ) {
                            var n = o.value;
                            n.style.display =
                              n.dataset.initialDisplay || e || 'block';
                          }
                        } catch (t) {
                          i.e(t);
                        } finally {
                            ...
                            try {
                              for (s.s(); !(i = s.n()).done; ) {
                                ...
                                void 0 !== n.fullyNamespacedEvents &&
                                  a in n.fullyNamespacedEvents &&
                                  n.removeEventListener(
                                    a,
                                    n.fullyNamespacedEvents[a]
                                  );
                              }
                            } catch (t) {
                              s.e(t);
